...
from BLADE import *
from BLADE.helpers.adminHelpers import DEVS, WHITELIST
from BLADE.helpers.basic import edit_or_reply
from BLADE.helpers.PyroHelpers import get_ub_chats
from BLADE.utils import extract_user, extract_user_and_reason
...
def globals_init():
    try:
        ...
        sql = import_module("BLADE.helpers.SQL.gban_sql")
        sql2 = import_module("BLADE.helpers.SQL.gmute_sql")
...
async def gban_user(client: Client, message: Message):
    ...
    if user_id in WHITELIST:
        return await X.edit(
            "**You can't fuck him because he's an hacker 😡**"
        )
    if user_id:
        try:
