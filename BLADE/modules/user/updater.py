...
from BLADE.helpers.misc import HAPP, XCB
from BLADE.helpers.tools import get_arg
from BLADE.utils.misc import restart
from BLADE.utils.pastebin import PasteBin
from BLADE.utils.tools import bash
...
add_command_help(
    "•─╼⃝𖠁 ᴜᴘᴅᴀᴛᴇ",
    [
        ["update", "Tᴏ ꜱᴇᴇ ᴀ ʟɪꜱᴛ ᴏғ ᴛʜᴇ ʟᴀᴛᴇꜱᴛ ᴜᴘᴅᴀᴛᴇꜱ ғʀᴏᴍ blade."],
